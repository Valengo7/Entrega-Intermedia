...
from .views import mostrar_curso_html, mostrar_index, mostrar_referencias, mostrat_repaso, crear_curso, crear_profesor, buscar_comision, buscar_profesor, crear_estudiante, buscar_estudiante


urlpatterns = [
    path('mostrar_curso_html/', mostrar_curso_html, name='Mostrar'),
    path('', mostrar_index),
    path('mostrar_referencias/', mostrar_referencias, name='Referencias'),
    path('mostrar_repaso/', mostrat_repaso, name='Repaso'),
