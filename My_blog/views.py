...
def mostrar_curso_html(request):
    ...
    saludo = f'Hola a todos, este es el curso de {curso.nombre}, con un numero de comision: {curso.comision}'

    return HttpResponse(saludo)
    #return render (request, 'mostrar_curso.html',{'nombre': curso.nombre, 'comision': curso.comision, 'esta_activo': curso.esta_activo})
...
def crear_estudiante(request):
    ...
    return render(request,'crear_estudiante.html', {'formulario': CrearEstudianteForm })
